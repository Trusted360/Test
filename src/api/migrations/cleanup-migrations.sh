...
# Archive the poorly designed separate migrations (using consolidated version)
...
echo ""
echo "✨ Only the baseline and consolidated auth migration remain active."
echo "   This provides a clean migration history for future development."